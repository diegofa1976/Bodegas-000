...
export const extractColorPalette = async (imageBase64: string): Promise<string[]> => {
  ...
  REGLA DE SALIDA:
  - Devuelve ÚNICAMENTE un objeto JSON con la propiedad "concepts" que contiene un array de 5 códigos hexadecimales.
  - Ejemplo: {"concepts": ["#800020", "#D4AF37", "#F5F5DC", "#004225", "#2F2F2F"]}`;
